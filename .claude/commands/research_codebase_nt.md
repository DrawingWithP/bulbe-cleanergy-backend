---
description: Documenta a base de código como ela é, sem avaliação nem recomendações
model: opus
---
...
4. **Aguarde todos os subagentes concluírem e sintetize as descobertas:**
   ...
   - Compile todos os resultados dos subagentes
...
5. **Reúna os metadados para o documento de pesquisa:**
   - Rode ferramentas Bash() para gerar todos os metadados relevantes
...
9. **Trate as perguntas de acompanhamento:**
   ...
   - Continue atualizando o documento
